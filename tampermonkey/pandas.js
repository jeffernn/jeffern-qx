...
(function() {
   ...
   `;
    ...
    /* 隐藏第二个字幕条目并收缩父容器 */
    div.vjs-subtitle-item:nth-of-type(2) {
        display: none !important;
        height: 0 !important;
        padding: 0 !important;
        margin: 0 !important;
    ...
    /* 隐藏所有三类图片并收缩父容器 */
    img.vjs-subtitle-title-icon,
    img.vjs-subtitle-item-icon,
    img.vjs-subtitle-item-badge {
        display: none !important;
    }
    ...
    img.vjs-subtitle-item-icon,
    img.vjs-subtitle-item-badge {
        /* 如果父容器是 div.vjs-subtitle-item，收缩父容器 */
        height: 0 !important;
        padding: 0 !important;
        margin: 0 !important;
    }
